...
public:
	...
	BOOL IsLastProcess();
	void CancelTransfer(FObject* object, FUIElement::EventArgs* args);
	BOOL IsLoggedIn();
...
protected:
	...
	void TransferStatusEnd(FObject* object, TransferStatus* status);
	void TransferStatusStart(FObject* object, TransferStatus* status);
	void TransferStatusTransmit(FObject* object, TransferStatus* status);
