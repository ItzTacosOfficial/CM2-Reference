...
public:
	...
	class FAK_PARTIAL Archive : public FArchive {
	...
	int unused40;
	HeaderV2 headerV2;
	FTArray<FName> namesV2; // Both classes and objects
	FTArray<ObjectInfoV2> objectsV2;
	unsigned int unkAC[22]; // Unknown FTMaps
	HeaderV2 previousHeaderV2;
	FTArray<FName> previousNamesV2; // Both classes and objects
	FTArray<ObjectInfoV2> previousObjectsV2;
	unsigned int unk14C[22]; // Previous unknown FTMaps
	HeaderV3 headerV3;
