...
class FUIElement : public FMutable {
...
public:
	...
	struct ControllerButtonEventArgs {};

	struct ControllerMoveEventArgs {};

	struct DragEventArgs {};

	struct EndCompositionEventArgs {};
