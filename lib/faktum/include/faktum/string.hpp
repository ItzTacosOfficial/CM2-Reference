...
FAK_IMPORT char* FtIToStrA(int, char*, int);
FAK_IMPORT wchar_t* FtIToStrW(int, wchar_t*, int);
FAK_IMPORT unsigned int FtStrAnsiToGeneric(wchar_t*, const char*, unsigned int);
FAK_IMPORT unsigned int FtStrAnsiToWide(wchar_t*, const char*, unsigned int);
FAK_IMPORT unsigned int FtStrGenericToAnsi(char*, const wchar_t*, unsigned int);
FAK_IMPORT unsigned int FtStrGenericToWide(wchar_t*, const wchar_t*, unsigned int);
FAK_IMPORT unsigned int FtStrHash(const char* str);
FAK_IMPORT unsigned int FtStrHash(const wchar_t* str);
FAK_IMPORT BOOL FtStrICmpA(const char*, const char*);
FAK_IMPORT BOOL FtStrICmpW(const wchar_t*, const wchar_t*);
FAK_IMPORT BOOL FtStrNICmpA(const char*, const char*, unsigned int);
FAK_IMPORT BOOL FtStrNICmpW(const wchar_t*, const wchar_t*, unsigned int);
FAK_IMPORT unsigned int FtStrPrintFCVA(const char*, char*);
FAK_IMPORT unsigned int FtStrPrintFCVW(const wchar_t*, char*);
FAK_IMPORT const char* FtStrRChrA(const char*, int, int);
FAK_IMPORT const wchar_t* FtStrRChrW(const wchar_t*, int, int);
FAK_IMPORT const char* FtStrRStrA(const char*, const char*, unsigned int);
FAK_IMPORT const wchar_t* FtStrRStrW(const wchar_t*, const wchar_t*, unsigned int);
FAK_IMPORT float FtStrToFA(const char*);
FAK_IMPORT float FtStrToFW(const wchar_t*);
FAK_IMPORT BOOL FtStrToIA(const char*);
FAK_IMPORT BOOL FtStrToIA(const char*, int);
FAK_IMPORT BOOL FtStrToIW(const wchar_t*);
FAK_IMPORT BOOL FtStrToIW(const wchar_t*, int);
FAK_IMPORT unsigned int FtStrToUIA(const char*, int);
FAK_IMPORT unsigned int FtStrToUIW(const wchar_t*, int);
FAK_IMPORT unsigned int FtStrWideToAnsi(char*, const wchar_t*, unsigned int);
FAK_IMPORT unsigned int FtStrWideToGeneric(wchar_t*, const wchar_t*, unsigned int);
FAK_IMPORT char* FtUIToStrA(unsigned int, char*, int);
FAK_IMPORT wchar_t* FtUIToStrW(unsigned int, wchar_t*, int);

FAK_IMPORT void _FtXToStr(unsigned int, char*, unsigned int, int);
